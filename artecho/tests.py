...
class ViewTests(TestCase):
    ...
    #this ones not passing - something about sessions i think?

    #def test_user_logout_view(self):
        #url = reverse('artecho:logout')
        #request = self.factory.get(aurl)
        #request.user = self.user
        #request.session = {}  # Create an empty session attribute
...
class SignUpFormTestCase(TestCase):
    def test_signup_form(self):
        ...
        # Missing email (This test should now pass as the form does not require email)
